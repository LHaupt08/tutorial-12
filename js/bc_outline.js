...
// Generate an outline based on h2 through h6 headings in source document.
window.addEventListener("load", makeOutline);

function makeOutline() {

   // Location of the document out outline
...
function createList(source, outlineList) {
   ...
   for (var n = source.firstChild; n !== null; n = n.nextSibling){
      ...
      if (headLevel !== -1) {
         // Add an id to the heading if it is missing headNum++;
         headNum++;
